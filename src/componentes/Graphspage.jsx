...
function Graphspage() {
    ...
    <div className="Graphspage">
            ...
            <Row>
                <Col  md={3} >
                    <div className="containerGraphs">
                        <center><p className="miniTitles">Recent Activity</p></center>
                    </div>
                </Col>
                <Col  md={{ span: 6, offset: 0.5 }}>
                    <div className="containerGraphs">
                    <center><p className="miniTitles">Anual Expenses</p></center>
                    </div>
                </Col>
                ...
                <Col>
                    <center>
                        ...
                        <button className="doubleButton" id="buttonAddNews">+</button>
                    </center>
                </Col>
            </Row>
        </Container>
        ...
        <Container>
            <Row>
                <div className="containerExpenses" id="containerGraph">
